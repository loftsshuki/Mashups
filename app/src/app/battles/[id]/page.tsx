...
const mockEntries: BattleEntry[] = [
  {
    ...
    mashup: {
      ...
      sourceTracks: [
        { title: "Neon Nights", artist: "Synthwave Collective" },
        { title: "Cyber Dreams", artist: "Digital Pulse" },
      ],
    },
    creatorId: "user-001",
  ...
  },
  {
    ...
    mashup: {
      ...
      sourceTracks: [
        { title: "Midnight City", artist: "Night Crawler" },
        { title: "Dark Drive", artist: "Shadow Synth" },
      ],
    },
    creatorId: "user-002",
  ...
  },
  {
    ...
    mashup: {
      ...
      sourceTracks: [
        { title: "Retro Wave", artist: "80s Revival" },
        { title: "Future Past", artist: "Time Travelers" },
      ],
    },
    creatorId: "user-003",
  ...
  },
  {
    ...
    mashup: {
      ...
      sourceTracks: [
        { title: "Digital World", artist: "Cyber Punk" },
        { title: "Horizon Line", artist: "Sky Walker" },
      ],
    },
    creatorId: "user-004",
