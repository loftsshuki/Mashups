...
export interface Battle {
  ...
  type: BattleType
  theme: BattleTheme
  themeValue?: string // e.g., "Hip-Hop" for genre theme
  status: BattleStatus
...
export const mockBattles: Battle[] = [
  {
    ...
    maxEntries: 32,
    entries: [], // Will be populated from mashups
  ...
  },
  {
    ...
    description: "Bring the 80s back! Create a mashup using only tracks from 1980-1989. Synth-pop, hair metal, new wave - anything goes!",
    type: "tournament",
    theme: "era",
    themeValue: "1980s",
    status: "active",
  ...
  },
  {
    ...
    description: "Fast and furious! Create a high-energy mashup with a minimum tempo of 150 BPM. Drum & bass, hardstyle, speed garage welcome!",
    type: "1v1",
    theme: "tempo",
    themeValue: "150+BPM",
    status: "upcoming",
  ...
  },
  {
    ...
    description: "No rules, no themes - just pure creativity! Submit your best mashup and compete for the grand prize.",
    type: "tournament",
    theme: "open",
    status: "completed",
    ...
    requirements: [
      "Optional: Include creative process notes"
    ],
...
export function getUserVoteCount(battleId: string, userId: string): number {
  // Mock - would check database
  return 0
}

export function hasUserSubmitted(battleId: string, userId: string): boolean {
  // Mock - would check database
  return false
}
...
export async function submitVote(
  ...
  // Mock implementation
  console.log(`Vote submitted: ${userId} voted for ${entryId} in battle ${battleId}`)
  return { success: true }
}
...
export async function submitEntry(
  ...
  // Mock implementation
  console.log(`Entry submitted: ${userId} submitted ${mashupId} to battle ${battleId}`)
  return { success: true }
}
