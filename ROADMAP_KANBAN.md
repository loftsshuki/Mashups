...
|------|-------------|---------------------|----------|------|--------|
| **Stem Separation Engine** | Integrate AI stem splitting (Demucs/Replicate API) | Upload track → 4 stems (vox/drums/bass/other) auto-extracted; draggable to mixer; <30s processing | TBD | 5d | 🔴 Not Started |
| **Visual Waveform Editor** | Figma-style multi-track timeline | Multi-track view; zoom 0.1-10x; clip drag/trim; crossfade handles; cut/copy/paste/split | TBD | 8d | 🔴 Not Started |
